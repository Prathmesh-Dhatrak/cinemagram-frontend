            ...
            {posts.map((post) => post.author && (
                ...
                >
                    ...
                    <div className="flex-grow p-2 pb-4 max-w-sm">
                        <h4
                            className="break-all overflow-hidden overflow-ellipsis h-12 font-normal dark:text-black"
                        ...
                        <div className="flex flex-col laptop:flex-row space-y-2 laptop:space-y-0 self-end">
                            <div className="flex">
                                <h6 className="text-xs text-black-400 laptop:mr-4">
                                    Posted by
                                    &nbsp;
                                    <span
                                        className="underline text-red-700 dark:text-red-700 cursor-pointer hover:text-red-400"
                            ...
                            <div className="flex space-x-2">
                                <h6 className="text-sm text-black-600 flex items-center">
                                    {post.likesCount}
                                    &nbsp;
                                    <LikeOutlined />
                                </h6>
