    ...
    return !searchQuery ? <Redirect to={'/'} /> : (
        <div className="min-h-screen pt-20">
            <div className="contain">
                <h2 className="text-lg laptop:text-2xl dark:text-black">
                    You searched for: &nbsp;
                    <span className="text-red-700 dark:text-red-700 break-all">{searchQuery}</span>
                </h2>
                <span className="text-black-400">Search Result</span>
                <ul className="space-x-4 mt-4">
                    <li
                        className={`inline-block border-b-4 border-transparent px-2 py-4 cursor-pointer font-medium hover:border-turquoise-700 text-black-400 ${searchType !== 'posts' && ' border-turquoise-700 text-black-900 dark:text-black dark:border-turquoise-400'}`}
                    ...
                    {searchType === 'posts' ? (
                        <div ref={infinitePostRef as React.RefObject<HTMLDivElement>}>
                            ...
                            {(!isLoadingPost && posts.length === 0 && error) && (
                                <div className="p-4 flex items-center justify-center">
                                    <span className="text-black-400 italic font-medium">
