            ...
            <div className="w-full laptop:w-2/4 relative">
                ...
                {props.isAuth && (
                    <div className="flex items-center justify-start mb-4 px-4 laptop:px-0">
                        ...
                        <div className="flex-grow">
                            <input
                                className="dark:bg-white !border-gray-800 text-black"
                                type="text"
                ...
                {(state.error && state.newsFeed.items.length === 0 && !state.isLoadingCreatePost) && (
                    <div className="flex flex-col w-full min-h-24rem px-8 items-center justify-center text-center">
                        {state.error.status_code === 404 ? (
                            <>
                                <CoffeeOutlined className="text-8xl text-white mb-4 dark:text-black-800" />
                                <h5 className="text-white">News feed is empty</h5>
                                <p className="text-white">Start following people or create your first post.</p>
                                <br />
                                <Link className="underline dark:text-red-700" to={SUGGESTED_PEOPLE}>
                                    See Suggested People
                                </Link>
                            </>
                        ) : (
                            <h5 className="text-white italic">
                ...
                {(!props.isAuth && !state.isLoadingFeed) && (
                    <div className="px-4 laptop:px-0 py-4 mb-4">
                        <h2 className="dark:text-white">Recent posts you may <br />find interesting.</h2>
                    </div>
                )}
                {/* ---- NEWS FEED ---- */}
