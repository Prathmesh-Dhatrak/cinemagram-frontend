...
const SocialAuthFailed = () => {
    ...
    return (
        <div className="contain pt-14 h-full">
            <h1 className="mt-8 text-2xl laptop:text-4xl dark:text-black">Failed to authenticate</h1>
            <br />
            <h4 className="text-black-600 dark:text-black-400">Possible cause(s):</h4>
