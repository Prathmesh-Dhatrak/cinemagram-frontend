                    ...
                    {(!coverPhoto.imageFile.file) && (
                        <>
                            <div
                                ...
                                className="w-full h-full laptop:w-60 laptop:h-60 !bg-cover !bg-no-repeat rounded-full border-4 border-white dark:border-turquoise-1000 overflow-hidden"
                                style={{
                ...
                <div className="flex w-full  flex-col self-end">
                    <div className="px-4 laptop:px-0 w-full flex items-center flex-col laptop:flex-row justify-between mb-2 laptop:ml-2 laptop:mr-14">
                        ...
                        <div className="text-center laptop:text-left mb-4 laptop:mb-0">
                            <h2 className="text-3xl text-white">{profile.fullname || `@${profile.username}`}</h2>
                            <span className="text-red-700 dark:text-red-700">{profile.fullname && `@${profile.username}`}</span>
                        </div>
                        ...
                        {!profile.isOwnProfile ? (
                            <div className="flex justify-center laptop:justify-start space-x-4 items-start">
                                ...
                                <button
                                    className="button--muted !border-gray-400 !rounded-full flex items-center dark:bg-indigo-1100 dark:text-black dark:hover:text-black dark:hover:bg-indigo-900 dark:!border-gray-800"
                            ...
                            <button
                                className="button--muted !rounded-full !border !border-gray-400 !focus:bg-gray-200 !py-2 flex items-center justify-center dark:bg-indigo-1100 dark:text-black dark:hover:text-white dark:hover:bg-indigo-900 dark:!border-gray-800"
