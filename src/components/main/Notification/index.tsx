        ...
        <div className="relative">
            <div onClick={toggleNotification}>
                <Badge count={unreadCount}>
                    <BellOutlined className="notification-toggle text-xl focus:outline-none text-black hover:bg-white rounded-full p-2" />
                </Badge>
            </div>
            {isNotificationOpen && (
                <div className="notification-wrapper border border-transparent dark:border-gray-800 fixed top-14 pb-14 laptop:pb-0 laptop:top-10 right-0 h-screen laptop:h-auto w-full laptop:w-30rem bg-white shadow-lg rounded-md laptop:absolute"
                >
                    {/*  ----- HEADER ----- */}
                    <div className="py-2 px-4 border-b-2 border-black flex justify-between items-center dark:bg-indigo-1000 laptop:rounded-t-md">
                        <h6 className="text-black">Notifications</h6>
                        <span
                            className="text-sm  p-2 text-black rounded-md hover:bg-indigo-500 hover:text-white"
