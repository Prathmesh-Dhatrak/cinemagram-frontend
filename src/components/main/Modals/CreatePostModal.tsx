        ...
        >
            <div className="relative">
                ...
                <div className="w-full laptop:w-40rem p-4 laptop:px-8">
                    <h2 className="dark:text-black">Create Post</h2>
                    <select
                        className="!py-1 !text-sm w-32 dark:bg-indigo-1100 dark:text-black dark:border-gray-800"
                        id="privacy"
                        name="privacy"
                    ...
                    >
                        ...
                        <option className='bg-white' value="follower">Follower</option>
                        <option className='bg-white' value="private">Only Me</option>
                    </select>
                    <br />
                    <br />
                    <div className="flex flex-col">
                        <textarea
                            className="dark:bg-indigo-1100 dark:text-black dark:!border-gray-800"
                            cols={3}
                            id="post"
                            name="post"
                        ...
                        <div className="flex items-center">
                            ...
                            <div className="flex items-center flex-grow">
                                ...
                                />
                                <label
                                    className="inline-flex items-center cursor-pointer justify-start border-gray-200 text-black-400 py-2 text-xs"
                                    htmlFor="photos"
                                >
                                    <div
                                        className="group flex items-center justify-center w-10 h-10 border-2 border-dashed border-gray-400 hover:border-turquoise-700"
                                        title="Upload photo"
                                    >
                                        <FileImageOutlined className="text-xl text-black-400 hover:text-red-700" />
                                    </div>
                                </label>
                            </div>
                            {/* ---- POST BUTTON --- */}
                            <div className="flex justify-end">
                                <button className='text-white bg-indigo-500' onClick={onSubmit} disabled={isLoadingCreatePost}>Create Post</button>
                            </div>
                        </div>
                        ...
                        <div className="flex items-center space-x-2">
                            {imageFile && imageFile.map((image) => (
                                ...
                                >
                                    <CloseCircleOutlined
                                        className="p-2 absolute top-0 left-0 right-0 bottom-0 margin-auto text-3xl text-black hover:bg-red-600 cursor-pointer outline-none opacity-75 hover:opacity-100"
