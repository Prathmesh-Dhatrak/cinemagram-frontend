...
const FollowButton: React.FC<IProps> = (props) => {
    ...
    return (
        <button
            className={`${isFollowing && 'hover:bg-gray-200 bg-indigo-100 !border !border-turquoise-500 dark:bg-white dark:hover:bg-indigo-500 dark:text-black dark:hover:text-white'} flex items-center text-white ${props.size === 'sm' && '!py-2 !px-3 !text-sm'}`}
            disabled={isLoading}
