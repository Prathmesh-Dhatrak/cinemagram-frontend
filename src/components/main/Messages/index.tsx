    ...
    return (
        <div className="relative">
            <div onClick={toggleMessages}>
                <Badge count={count}>
                    <MessageOutlined className="messages-toggle text-xl focus:outline-none dark:text-black hover:bg-white rounded-full p-2" />
                </Badge>
            </div>
            {isMessagesOpen && (
                <div className="messages-wrapper h-screen border border-transparent dark:border-gray-800 laptop:h-auto fixed top-14 laptop:top-10 pb-14 laptop:pb-0 right-0 w-full laptop:w-30rem bg-white shadow-lg laptop:rounded-md laptop:absolute">
                    {/*  ----- HEADER ----- */}
                    <div className="px-4 py-2 border-black border flex justify-between items-center dark:bg-indigo-1000 laptop:rounded-t-md">
                        <h6 className="text-black">Messages</h6>
                        <span
                            className="text-sm flex p-2 text-black rounded-md hover:text-white hover:bg-indigo-500"
