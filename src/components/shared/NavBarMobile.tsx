...
const NavBarMobile: React.FC<IProps> = ({ theme, isAuth, auth, openModal }) => {
    ...
    return isOpenSearch ? (
        <div className="fixed top-0 left-0 flex w-full items-center bg-indigo-1000 z-9999 py-2 pr-2 shadow-xl">
            <div
                className="p-2 rounded-full flex items-center justify-center cursor-pointer hover:bg-indigo-500"
                onClick={() => setOpenSearch(false)}
            >
                <ArrowLeftOutlined className="text-black" style={{ fontSize: '18px' }} />
            </div>
            <SearchInput
        ...
        <nav className="contain flex justify-between z-9999 align-center w-100 border-b border-transparent bg-white dark:bg-indigo-1000 text-black-700 h-60px py-2 fixed top-0 left-0 w-full shadow-md laptop:shadow-sm dark:border-gray-800">
            ...
            <div className="flex items-center space-x-4 laptop:hidden">
                ...
                <div
                    className="p-2 rounded-full flex items-center justify-center cursor-pointer hover:bg-gray-200 dark:text-black dark:hover:bg-indigo-1100"
            ...
            <div className={`flex  flex-col w-full h-screen fixed top-0 right-0 transition-transform  transform ${isOpenMenu ? 'translate-x-0' : 'translate-x-full'} bg-white dark:bg-indigo-1000 laptop:hidden`}>
                <div className="flex items-center justify-between px-4">
                    <div className="flex items-center space-x-4">
                        <h1 className="dark:text-black">Menu</h1>
                    </div>
                    <div
                        className="p-2 rounded-full flex items-center justify-center cursor-pointer hover:bg-gray-200 dark:text-black dark:hover:bg-indigo-1100"
                ...
                {isAuth ? (
                    <ul className="divide-y divide-gray-100 dark:divide-gray-800">
                        <li className="px-4 py-3 pb-4 cursor-pointer hover:bg-indigo-100 dark:hover:bg-indigo-1100">
                            <Link
                                className="flex font-bold dark:text-red-700"
                            ...
                            >
                                ...
                                <div className="flex flex-col">
                                    ...
                                    <span className="text-black text-xs">View Profile</span>
                                </div>
                            </Link>
                        </li>
                        <li className="p-4 cursor-pointer hover:bg-indigo-100 dark:hover:bg-indigo-1100">
                            ...
                            >
                                <TeamOutlined className="text-red-700 dark:text-red-700" style={{ fontSize: '30px', marginRight: '25px' }} />
                        ...
                        <li className="p-4 cursor-pointer hover:bg-indigo-100 dark:hover:bg-indigo-1100">
                            ...
                            >
                                <StarOutlined className="text-red-700 dark:text-red-700" style={{ fontSize: '30px', marginRight: '25px' }} />
                        ...
                        <li className="p-4 cursor-pointer hover:bg-indigo-100 dark:hover:bg-indigo-1100">
                            <Link
                                ...
                                to={SUGGESTED_PEOPLE}
                            >
                                <UsergroupAddOutlined className="text-red-700 dark:text-red-700" style={{ fontSize: '30px', marginRight: '25px' }} />
                        ...
                        <li className="p-4 cursor-pointer hover:bg-indigo-100 dark:hover:bg-indigo-1100">
                            ...
                            >
                                ...
                                <h6 className="text-sm text-black">Logout</h6>
                            </div>
                        </li>
                    </ul>
                ) : (
                    <ul className="divide-y divide-gray-100 dark:divide-gray-800">
                        <li className="px-4 cursor-pointer hover:bg-indigo-100 dark:hover:bg-indigo-1100 flex items-center justify-start">
                            <ArrowRightOutlined className="dark:text-black" />
                            <Link
                                className="p-4 font-medium dark:text-red-700 flex-grow"
                                to={LOGIN}
                            >
                                Login
                            </Link>
                ...
                {/* --- COPYRIGHT -- */}
                <span className="text-black-400 text-xs absolute bottom-8 left-0 right-0 mx-auto text-center">
